						...
						<!-- One -->
							<section id="one">
								...
								<div class="container">
									...
									<p class="text-secondary text-center">Somos una empresa dedicada a la producción y comercialización de galletas, hechas com amor</p>
								</div>
							</section>
			...
			?>
							...
							<section id="three">
								<div class="container">
									...
									<p class="text-secondary text-center mb-5">Nuestras galletitas mas vendias</p>
									<div class="features">
										<article>
										...
										<article>
											...
											<div class="inner">
												...
												<p class="text-secondary text-center">Las mas vendias </p>
											</div>
										</article>
										<article>
